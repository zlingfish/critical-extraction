...
export const GEAR_CATALOG: GearItem[] = [
  { id: 'starter-helmet', name: '巡逻 M1 头盔', category: 'helmet', rarity: 'white', price: 0, weight: 1.4, icon: 'hard-hat', armorBonus: 2, description: '基础复合材料头盔，提供少量额外防护。' },
  ...
  { id: 'starter-armor', name: '轻型巡逻背心', category: 'armor', rarity: 'white', price: 0, weight: 4.2, icon: 'shield', armorBonus: 5, description: '基础插板背心，兼顾行动速度与防护。' },
  ...
  { id: 'starter-pack', name: '侦察 12 格背包', category: 'backpack', rarity: 'white', price: 0, weight: 1.2, icon: 'backpack', backpackSlots: 12, description: '轻量行动背包，可容纳 12 种不同物资。' },
  ...
  { id: 'starter-medical', name: '基础急救包', category: 'medical', rarity: 'white', price: 0, weight: 0.6, icon: 'briefcase-medical', medkitBonus: 0, description: '标准止血与包扎用品。' },
  ...
  { id: 'weapon-rifle', name: 'KR-56 突击步枪', category: 'weapon', rarity: 'white', price: 0, weight: 3.7, icon: 'crosshair', weaponId: 'rifle', ammoBonus: 0, description: '均衡可靠的制式突击步枪。' },
...
export function resolveLoadout(profile: PersistentProfile): {
  ...
  return {
    ...
    backpackSlots: (backpack?.backpackSlots ?? 12) + warehouseSlots,
