...
import { resolveAimSpread, resolveDamageAtDistance, resolvePelletDamage, resolveRecoilStep, resolveReloadDuration, resolveWeaponClearance, WEAPON_FEEL_PROFILES } from './weapon-feel';
...
describe('weapon recoil profiles', () => {
  ...
  it('keeps V9 at 45 damage per pellet and 90 damage per shot', () => {
